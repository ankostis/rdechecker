...
def parse_call_spec(call_spec, no_recurse=False):
    ...
    """
    _coconut_match_to = call_spec
    _coconut_match_check = False
    if _coconut.isinstance(_coconut_match_to, str):
        rule = _coconut_match_to
        _coconut_match_check = True
    if _coconut_match_check:
        return (rule, [], {})

    if not _coconut_match_check:
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to) == 3) and (_coconut.isinstance(_coconut_match_to[0], str)) and (_coconut.isinstance(_coconut_match_to[1], (list, tuple))) and (_coconut.isinstance(_coconut_match_to[1], _coconut.abc.Iterable)) and (_coconut.isinstance(_coconut_match_to[2], _coconut.abc.Mapping)):
            rule = _coconut_match_to[0]
            args = _coconut.list(_coconut_match_to[1])
            kwds = dict((k, v) for k, v in _coconut_match_to[2].items() if k not in set(()))
            _coconut_match_check = True
        if _coconut_match_check:
            return (rule, args, kwds)
    if not _coconut_match_check:
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to) == 2) and (_coconut.isinstance(_coconut_match_to[0], str)) and (_coconut.isinstance(_coconut_match_to[1], (list, tuple))) and (_coconut.isinstance(_coconut_match_to[1], _coconut.abc.Iterable)):
            rule = _coconut_match_to[0]
            args = _coconut.list(_coconut_match_to[1])
            _coconut_match_check = True
        if _coconut_match_check:
    ...
    if not _coconut_match_check:
        ...
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Mapping)) and (_coconut.len(_coconut_match_to) == 1):
            ...
            if (_coconut_match_temp_0 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_0, str)):
                rule = _coconut_match_temp_0
                _coconut_match_check = True
        if _coconut_match_check:
            return (rule, [], {})
    if not _coconut_match_check:
        ...
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Mapping)) and (_coconut.len(_coconut_match_to) == 2):
            _coconut_match_temp_0 = _coconut_match_to.get('func', _coconut_sentinel)
            _coconut_match_temp_1 = _coconut_match_to.get('args', _coconut_sentinel)
            if (_coconut_match_temp_0 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_0, str)) and (_coconut_match_temp_1 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_1, (list, tuple))) and (_coconut.isinstance(_coconut_match_temp_1, _coconut.abc.Iterable)):
                rule = _coconut_match_temp_0
                args = _coconut.list(_coconut_match_temp_1)
                _coconut_match_check = True
        if _coconut_match_check:
            return (rule, args, {})
    if not _coconut_match_check:
        ...
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Mapping)) and (_coconut.len(_coconut_match_to) == 2):
            _coconut_match_temp_0 = _coconut_match_to.get('func', _coconut_sentinel)
            _coconut_match_temp_1 = _coconut_match_to.get('kwds', _coconut_sentinel)
            if (_coconut_match_temp_0 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_0, str)) and (_coconut_match_temp_1 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_1, _coconut.abc.Mapping)):
                rule = _coconut_match_temp_0
                kwds = dict((k, v) for k, v in _coconut_match_temp_1.items() if k not in set(()))
                _coconut_match_check = True
        if _coconut_match_check:
            return (rule, [], kwds)
    if not _coconut_match_check:
        _coconut_sentinel = _coconut.object()
        if (_coconut.isinstance(_coconut_match_to, _coconut.abc.Mapping)) and (_coconut.len(_coconut_match_to) == 3):
            _coconut_match_temp_0 = _coconut_match_to.get('func', _coconut_sentinel)
            _coconut_match_temp_1 = _coconut_match_to.get('args', _coconut_sentinel)
            _coconut_match_temp_2 = _coconut_match_to.get('kwds', _coconut_sentinel)
            if (_coconut_match_temp_0 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_0, str)) and (_coconut_match_temp_1 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_1, (list, tuple))) and (_coconut.isinstance(_coconut_match_temp_1, _coconut.abc.Iterable)) and (_coconut_match_temp_2 is not _coconut_sentinel) and (_coconut.isinstance(_coconut_match_temp_2, _coconut.abc.Mapping)):
                rule = _coconut_match_temp_0
                args = _coconut.list(_coconut_match_temp_1)
                kwds = dict((k, v) for k, v in _coconut_match_temp_2.items() if k not in set(()))
                _coconut_match_check = True
        if _coconut_match_check:
            return (rule, args, kwds)
...
#
    if not _coconut_match_check:
        if _coconut.isinstance(_coconut_match_to, (list, tuple)):
            call_specs = _coconut_match_to
            _coconut_match_check = True
        if _coconut_match_check and not (not no_recurse):
            _coconut_match_check = False
        if _coconut_match_check:
            return [parse_call_spec(r, no_recurse=True) for r in call_specs]
    if not _coconut_match_check:
